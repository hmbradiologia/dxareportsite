		...
		<div class="tecnica">
			...
			<div class="coluna">	
				<p> <b>COLUNA LOMBAR :</b> <?= $slombar ?> Imagem e gráfico obtidos em exame anexo representando valor			
					...
					Z-score: <?= $zslomb ?> desvios-padrão em relação a população referência com a mesma idade.
				</p>		
				<p> O segmento estudado apresenta-se <?= $resultlomb ?> </p>
			</div>
			...
			<div class="femur">					
				<p><b>FÊMUR :</b>  Imagem e gráfico obtidos em anexo representando valor médio da densidade mineral	óssea (DMO) da região proximal do fêmur:</br>
					...
					Z-score: <?= $zscolo ?>	desvios-padrão em relação a população referência com a mesma idade.	</br>
					Femur Total: <?=$dmoft ?>g/cm<sup>2</sup>					</br>
					Z-score: <?= $zsft ?> desvios-padrão em relação a população referência com a mesma idade.</p>
					
					<p> O segmento estudado apresenta-se <?= $resultfemur ?> </p>
				</div>
