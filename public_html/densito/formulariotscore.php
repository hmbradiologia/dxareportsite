...
<fieldset>
	...
	<label for="">TSCORE COLUNA</label>  <input type="number" id="tslomb" name="tslomb" step="0.1" min="-100" max ="100" size="4" maxlength="4" placeholder="ex: -2.8"></br>
	<label for="">DMO COLUNA</label>  <input type="number" id="dmolomb" name="dmolomb" step="0.001" min="-100" max ="100" size="6" maxlength="6" placeholder="ex: 0.893"></br>
...
<fieldset>
	<label for="">TSCORE COLO</label>  <input type="number" id="tscolo" name="tscolo" step="0.1" min="-100" max ="100" size="4" maxlength="4" placeholder="ex: -2.8"></br>
...
<fieldset>
	<label for="">TSCORE FEMUR TOTAL</label> <input type="number" id="tsft" name="tsft" step="0.1" min="-100" max ="100" size="4" maxlength="4" placeholder="ex: -2.8"> </br>
